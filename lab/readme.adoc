...
If you find any issues, report it in the link:https://github.com/yanaga/workshop-openshift/rbc/issues[Github repository]. You're also welcome to send any link:https://help.github.com/articles/using-pull-requests/[pull requests] and contributions.
